-- ============================================================================
-- Universal Import Framework — Opening Stock import (match-required)
--   Adds a `stock` branch to import_commit: match a product by name, set its
--   opening_stock. Update-only, requires `manage_stock`. Outstanding branch
--   (contacts.opening_balance) already exists. CREATE OR REPLACE; only the new
--   stock branch differs from the previous version.
-- ============================================================================
