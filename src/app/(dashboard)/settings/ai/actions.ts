...
export async function addKnowledgeDocument(formData: FormData) {
  try {
    ...
    console.error('CRITICAL UNCAUGHT ERROR in addKnowledgeDocument:', globalErr)
    return { error: `Critical server error: ${globalErr.message}` }
  }
}
...
export async function deleteKnowledgeDocument(docId: string) {
  try {
    ...
    console.error('CRITICAL UNCAUGHT ERROR in deleteKnowledgeDocument:', globalErr)
    return { error: `Critical server error: ${globalErr.message}` }
  }
}
...
export async function updateKnowledgeDocument(docId: string, formData: FormData) {
  try {
    ...
    console.error('CRITICAL UNCAUGHT ERROR in updateKnowledgeDocument:', globalErr)
    return { error: `Critical server error: ${globalErr.message}` }
  }
}
