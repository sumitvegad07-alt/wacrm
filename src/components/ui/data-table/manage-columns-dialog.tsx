          ...
          >
            ...
            >
              {items.map((id) => {
                ...
                // Skip system columns with no label and the pinned row-actions
                // column — they shouldn't be toggleable or reorderable, and
                // rendering them produced a blank, nameless row.
                if (!col || !col.label || col.id === "actions") return null;
                return (
                  <SortableColumnItem
                    key={id}
                    id={id}
