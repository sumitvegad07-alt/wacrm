...
export function BulkActionBar({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-4 px-4 py-2.5 rounded-xl border border-border bg-card shadow-md animate-in fade-in-0 slide-in-from-bottom-2 duration-200",
        className
      )}
      {...props}
    >
